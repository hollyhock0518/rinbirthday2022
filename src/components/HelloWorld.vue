							...
							<div class="cardtest">
								...
								<v-card class="msg-box" height="200px" @click.stop="member.dialog = true"
									...
									<v-container>
										<v-row>
											<v-col cols="2">
												<v-img src="~@/assets/twittericon/hollyhock0518.jpg"></v-img>
											</v-col>
											<v-col cols="10">
...
export default {
	data() {
		return {
			members: [
				{ dialog: false, name: "神条りゅーと", icon: "", message: "りんちゃんお誕生日おめでとうございます、自分がりんちゃんを知って初めてのお誕生日を祝させてもらいます。\nこれからもりんちゃんも体調に気を付けて皆を癒してくださいね大好きです❤️(*￣∇￣*)" },
				...
				{ dialog: false, name: "ジノネコ", icon: "", message: "りんちゃんお誕生日おめでとう！これからもりんちゃんを応援して支えていくからね！" },
				{ dialog: false, name: "シンジロー", icon: "", message: "りんちゃん お誕生日おめでとうございます！🎉🎂🎉\n1on1でお話出来てうれしかったよ！\nこれからも応援していくので宜しくね！\n次はクラファンかな？全力で応援するからね！" },
				{ dialog: false, name: "はる", icon: "", message: "りんちゃん！！お誕生日おめでとう！！\n生まれてきてくれてありがとう！( *´꒳`* )\nいつも癒してくれてありがとう！\nりんちゃんにあえて私は幸せだよ♡これからもずっとずっと大好きです♡\nこれからも体調に気をつけて配信頑張ってね！！" },
				{ dialog: false, name: "†エルゼン†【バカ】", icon: "", message: "誕生日おめでとう！！\n僕はこの誕生日がりんちゃんの誕生日を初めてお祝いする機会だけど、配信では二回目の誕生日なんだよね。　もっと早く知っていれば…グヌヌ…\n\n879.2歳、おめでとう！" },
				{ dialog: false, name: "rokuku", icon: "", message: "りんりんお誕生日おめでとう！！！\n去年は今年もりんの誕生日に付き添う約束をして、できたよ！\nこの1年もいろいろなことお疲れ様でした！これからもずっとりんに添っているよ~~\n\n大好き大好き！！！♡♡" },
				{ dialog: false, name: "彼岸の兔子", icon: "", message: "お誕生日おめでとうございます。時間が経つのは速いですね。\nいつのまにか凛ちゃんと付き合ってそんなに経ってしまった。\n前年の凛ちゃんの誕生日、凛ちゃんは天使のように私の元に降りてきた。\n今日もこの誕生日を一緒に楽しく過ごしてね。毎日楽しく過ごさなければなりません。\n私は凛ちゃんを愛しています。永遠に愛しています。\nずっと離れないよ。\n一生あなたが好きです。\n小凛最可爱了。りんちゃんはウサギがこの世で一番好きな人です。\n生日快乐呀～りんりん" },
				{ dialog: false, name: "かつあん", icon: "", message: "誕生日おめでとうございます\nりんさんにとってより良い一年になりますようにお祈り申し上げます" },
				{ dialog: false, name: "河東みさき", icon: "", message: "りんちゃん、お誕生日おめでとうございます！体制が整うまで、大変だった事を聴いてたけど良く頑張りましたね！（偉い^ ^\nりんちゃんのこれからが、更に明るくて楽しいものになる事を祈ってます(о´∀`о)\nりんちゃんの笑顔なら、沢山の人を照らせますよ☆" },
